...
이미 미션의 최소 기준인 의미 있는 커밋 10개 이상을 충족했습니다. 이번 보완
내용을 커밋하면 총 커밋 수는 19개 이상이 됩니다. 스냅샷 전체 원문은
...
| --- | --- | --- |
| #5 원격·10개 이상 커밋 | 원격 URL, 커밋 수 18개, 전체 로그와 이미지 제공 | 8.1, `docs/git-evidence.txt`, 12번 이미지 |
